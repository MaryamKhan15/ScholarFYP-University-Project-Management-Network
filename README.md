# ScholarFYP - University Project Management Network
...
### 1. 🎓 Student Journey
- **Student Dashboard**: Live tracking of proposal approval state, active project sprint, completion percentage, and supervisor feedback (single-screen viewport fit).
...
> ℹ️ **Security Note on Credentials**: The accounts listed below are public demo test credentials generated by `seed.js` strictly for university evaluation and testing purposes. No production secrets or real personal credentials are present in this repository. All private configuration values (such as database URIs and JWT secrets) belong in `.env` environment variables.
...
- **Author**: **Maryam Khan**
- **Project Title**: **ScholarFYP** (*University Project Management Network*)
- **Role**: Full-Stack Developer & Lead Designer
- **Repository**: [ScholarFYP GitHub Repository](https://github.com/MaryamKhan15/ScholarFYP-University-Project-Management-Network)
